...
<head>
    ...
    <link rel="stylesheet" href="../../css/humanas.css">
...
<body>
    <section>
        <header>
            ...
            <h1>Anotações</h1>
            <div class="add">
                <a href="../../paginas/add.php?soc"><button>+</button></a>
            </div>
            <?php
                if($total > 0){
                    do{
                        $mt = "SELECT * from soc where Divisao = ".$dados['Id']." and usuario = 0 or Divisao = ".$dados['Id']." and usuario = ".$_SESSION['Id']."";
